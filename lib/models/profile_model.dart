...
class Profile {
  ...
  factory Profile.fromJson(Map<String, dynamic> json) {
    // Helper to get value with multiple naming conventions
    ...
    return Profile(
      ...
      household: _getString('household'),
      family: _getString('family'),
  ...
  @override
  String toString() {
    return 'Profile(id: $id, name: $fullName, barangay: $barangay, age: $age)';
  }
}